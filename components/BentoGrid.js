...
const items = [
  ...
  {title: 'Platform Engineering', body: 'Reliable infra, observability, and CI pipelines to ship with confidence.'},
  {title: 'Optimization & Insights', body: 'Experimentation platforms and dashboards that drive actionable decisions.'}
]
