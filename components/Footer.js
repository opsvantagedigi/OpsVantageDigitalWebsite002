      ...
      <div className="container py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="mt-3 text-sm text-muted-2">
            Revenue acceleration infrastructure for growth-focused teams.
          </p>
          <div className="flex gap-3 mt-4">
            <a
              href="https://linkedin.com/company/opsvantagedigital"
              target="_blank"
              rel="noopener"
              aria-label="LinkedIn"
              className="hover:text-ovd-blue focus-visible:outline-ovd-blue"
            >
              <svg
                width="22"
                height="22"
            ...
            <a
              href="https://twitter.com/opsvantage"
              target="_blank"
              rel="noopener"
            ...
            >
              <svg
                ...
                aria-hidden="true"
              >
                <path d="M22.162 5.656c-.793.352-1.645.59-2.54.698.913-.547 1.615-1.414 1.946-2.448-.855.508-1.803.877-2.81 1.077-.807-.86-1.958-1.398-3.234-1.398-2.448 0-4.434 1.986-4.434 4.434 0 .348.04.687.115 1.012-3.686-.185-6.953-1.951-9.137-4.634-.382.656-.601 1.418-.601 2.233 0 1.54.784 2.899 1.978 3.696-.728-.023-1.413-.223-2.012-.557v.056c0 2.152 1.531 3.946 3.566 4.353-.373.102-.765.157-1.17.157-.286 0-.561-.028-.831-.08.562 1.753 2.192 3.029 4.125 3.062-1.51 1.184-3.417 1.89-5.49 1.89-.357 0-.709-.021-1.056-.062 1.957 1.256 4.285 1.99 6.787 1.99 8.142 0 12.6-6.747 12.6-12.6 0-.192-.004-.384-.013-.574.865-.624 1.615-1.404 2.21-2.292z" />
              </svg>
            </a>
            <a
              href="https://github.com/opsvantage"
              target="_blank"
              rel="noopener"
              aria-label="GitHub"
              className="hover:text-ovd-blue focus-visible:outline-ovd-blue"
          ...
          <p className="mt-4 text-xs text-muted-2">
            © {new Date().getFullYear()} OpsVantage Digital
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-muted-2">
            Move faster with governance-grade systems.
          </p>
          <div className="mt-4">
