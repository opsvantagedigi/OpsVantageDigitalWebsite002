...
const posts = [
  ...
  {
    slug: "experiment-platforms",
    title: "Experimentation Platforms That Scale",
  },
];
            ...
            <Card key={p.slug} className="card-surface">
              ...
              <CardContent>
                <p className="text-sm text-muted-2">
                  A short preview of the insight to invite curiosity and action.
                </p>
                <div className="mt-4">
                  <Link
                    href={`/insights/${p.slug}`}
                    className="text-sm text-ovd-green"
                  >
                    Read →
                  </Link>
                </div>
