      ...
      <main className="container mx-auto px-6 py-12 max-w-3xl flex-1">
        ...
        <section className="space-y-10">
          <div>
            ...
            <p>
              We begin every project by understanding your story, goals,
              challenges, and customers. This ensures every solution is tailored
              to your real needs.
            </p>
          </div>
          <div>
            ...
            <p>
              We design systems with clarity, scalability, and security in mind.
              Our architecture is future-proof, compliant with ISO/IEC
              standards, and built for maintainability.
            </p>
          </div>
          <div>
            <h2 className="text-2xl font-semibold mb-2">3. Implementation</h2>
            <p>
              We build with discipline, using modern engineering practices,
              accessibility standards, and rigorous testing. Every detail is
          ...
          <div>
            ...
            <p>
              We don’t disappear after launch. We monitor, maintain, and improve
              your platform, providing ongoing support, updates, and
              governance-grade care.
            </p>
          </div>
          <div>
            ...
            <p>
              We believe in iterative growth. We analyze performance, gather
              feedback, and optimize systems to ensure your digital foundation
        ...
        <section className="mt-12">
          ...
          <ul className="list-disc list-inside text-sm text-slate-600 dark:text-slate-300">
            ...
            <li>
              Accessibility (WCAG 2.1 AA), non-discrimination, and privacy by
              design
            </li>
